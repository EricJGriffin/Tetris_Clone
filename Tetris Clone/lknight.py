...
class Lknight:
    ...
    def __init__(self, window):
        ...
        # 'left'. the direction refers to the 'left knight chess'
        ...
        self.activeState = "right" # the method to represent this is .orientation()
##################################################################################
...
#################################################################################
    ...
    def rightEdge(self):
        if self.activeState == "up":
            return round(self.MM.getCenter().getX() + 0.15, 2)
        elif (self.activeState == "down" or self.activeState == "right" or
              self.activeState == "left"):
